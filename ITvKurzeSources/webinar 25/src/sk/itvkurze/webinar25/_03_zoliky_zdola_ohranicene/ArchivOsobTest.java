...
//    	Osoba[] osoby = zamestnanci;
    ...
    @Test
    public void testNacitaniaZoznamuOsob() throws Exception
    {
    	zapisovac.uloz(peter_kovac);
    	zapisovac.uloz(julo_matas);
    	
    	List<Object> osoby = new ArrayList<>();
    	citac.nacitaj(osoby);
    	
    	assertEquals(peter_kovac, osoby.get(0));
    	assertEquals(julo_matas, osoby.get(1));
    }
