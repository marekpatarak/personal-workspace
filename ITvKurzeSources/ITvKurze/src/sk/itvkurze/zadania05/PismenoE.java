...
public class PismenoE extends Pismeno {

	public PismenoE(int x, int y, int width, int height) {
	...
	public void nakresli(Graphics2D g2) {
		...
		Line2D.Double ciara3 = new Line2D.Double(this.hornyRohX, this.hornyRohY, this.hornyRohX + this.width,
				this.hornyRohY);
		Line2D.Double ciara4 = new Line2D.Double(this.hornyRohX, this.hornyRohY + this.height,
