package sk.itvkurze.swing._39_integracia_swing_a_databaza.controller;
...
import sk.itvkurze.swing._39_integracia_swing_a_databaza.gui.FormularEvent;
...
public class Controller
{
	...
	public void vlozOsobu(FormularEvent event)
	{
		...
		Entity osoba = new Entity(meno, zamestnanie, vekovaKategoria, zamStatus, jeCudzinec, statnaPrislusnost, pohlavie);
		db.vlozOsobu(osoba);
	}
