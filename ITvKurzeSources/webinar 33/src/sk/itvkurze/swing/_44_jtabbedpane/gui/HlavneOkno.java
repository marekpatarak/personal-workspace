package sk.itvkurze.swing._44_jtabbedpane.gui;
...
import sk.itvkurze.swing._44_jtabbedpane.controller.Controller;
...
public class HlavneOkno extends JFrame
{
	...
	public HlavneOkno()
	{
		...
		tabPane.add("Databaza Osob", tabulka);
		tabPane.add("Spravy", panel);
		
		// komponenty umiestnujeme zlava doprava v horizontalnom smere
		splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, formular, tabPane);
		...
		add(panelSNastrojmi, BorderLayout.PAGE_START);
	...
	private JMenuBar vytvorMenuBar()
	{
		...
		zobrazFormularItem.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					splitPane.setDividerLocation((int)formular.getMinimumSize().getWidth());
				}
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				*/
				...
				if (odpoved == JOptionPane.OK_OPTION)
				{
					...
					{
						windowListener.windowClosing(new WindowEvent(HlavneOkno.this, WindowEvent.WINDOW_CLOSING));
					}
				}
			}
		});
